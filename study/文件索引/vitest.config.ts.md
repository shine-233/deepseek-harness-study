...
### [vitest.config.ts](https://github.com/deepseek-ai/deepseek-harness/blob/aa6c361a972c8369148dea7380bb5c21c24e07ec/vitest.config.ts)

- 所属层：仓库根部的构建、测试或开发入口
- 文件角色：构建或测试配置
- 这个文件有什么用：它告诉工具链怎样处理 `vitest.config.ts` ：从哪里开始、使用哪个环境、解析哪些依赖以及输出什么产物；这些规则集中后，构建和测试才可重复。
