...
| 工具被拒绝 | `guard()` 或权限决策保持拒绝，不能由后续处理器偷偷放行 |
...
本学习仓库的固定上游提交是 `47f943859bef60e4160492346772ded9b24f765a`。索引中的源码链接和本文的官方链接都固定到这个提交；自动索引的 import、声明、测试主题是静态定位证据，不等于已运行 DSH。
...
- [添加工具的官方 cookbook](https://github.com/deepseek-ai/deepseek-harness/blob/47f943859bef60e4160492346772ded9b24f765a/docs/cookbook/adding-a-tool.zh.md)
- [扩展开发 cookbook](https://github.com/deepseek-ai/deepseek-harness/blob/47f943859bef60e4160492346772ded9b24f765a/docs/cookbook/extension-cookbook.zh.md)
- [发布指南](https://github.com/deepseek-ai/deepseek-harness/blob/47f943859bef60e4160492346772ded9b24f765a/docs/user/develop/basic/publish.zh.md)
- [工具插件 README](https://github.com/deepseek-ai/deepseek-harness/tree/47f943859bef60e4160492346772ded9b24f765a/packages/core/tools)
