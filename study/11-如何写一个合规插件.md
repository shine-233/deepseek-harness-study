...
根据 [DSH 固定提交的官方测试策略](https://github.com/deepseek-ai/deepseek-harness/blob/47f943859bef60e4160492346772ded9b24f765a/docs/testing.zh.md)，面向产品用户的插件需要使用真实组合测试，而不是只手工创建一个 Context 并断言某个函数被调用。
