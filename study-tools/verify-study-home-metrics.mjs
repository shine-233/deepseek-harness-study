...
function main() {
  ...
  if (report.errors.length === 0) {
    console.log(`verify-study-home-metrics: ${report.expected['页中文教材']} 页教材、${report.expected['个逐文件导读卡']} 张导读卡、${report.expected['个离线实验']} 个离线实验，全部对账一致。`)
    return 0
  }
