...
export const LAB_PAGE_IDS = ['turn-flow', 'package-graph', 'profile-loader', 'session-log', 'tool-visibility', 'code-mode-evidence', 'compaction', 'plugin-flow', 'llm-stream', 'hook-flow']
