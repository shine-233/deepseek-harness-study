...
const RELATED = Object.freeze({
  ...
  'session-log': ['turn-flow', 'session-fork', 'workflow-node', 'storage-hub'],
  'tool-visibility': ['fs-edit', 'skill-catalog', 'web-tool'],
  'fs-edit': ['tool-visibility', 'provider'],
  'web-tool': ['fs-edit', 'provider'],
  'code-mode-evidence': ['worker-protocol', 'jobs', 'code-run'],
  'compaction': ['session-projection', 'workflow-node'],
  'plugin-flow': ['guard-loop', 'plan-stack', 'invariant'],
  ...
  'client': ['workflow-node', 'provider', 'host-gateway'],
  ...
  'code-run': ['code-mode-evidence', 'worker-protocol'],
  'host-gateway': ['client', 'wire', 'provider'],
  'invariant': ['plugin-flow', 'guard-loop'],
  'storage-hub': ['session-log', 'query', 'checkpoint'],
  'credential': ['settings', 'identity'],
  'settings': ['credential', 'host-gateway'],
  'plan-stack': ['workflow-node', 'orchestration', 'preset'],
  'spill': ['subprocess', 'web-tool'],
  'terminal': ['shell-seam', 'subprocess'],
  'mcp': ['skill-catalog', 'tool-visibility'],
  'selfmod': ['plugin-flow', 'invariant', 'skill-catalog'],
  'subprocess': ['terminal', 'jobs', 'spill'],
  'lsp': ['shell-seam', 'mcp'],
  'wire': ['worker-protocol', 'host-gateway'],
  'tokenmeter': ['llm-stream', 'compaction'],
  'preset': ['profile-loader', 'plan-stack'],
  'checkpoint': ['session-log', 'session-fork', 'storage-hub'],
  'identity': ['credential', 'settings'],
  'time': ['context', 'prompt-assembly'],
  'attachment': ['fs-edit', 'client'],
  'feedback': ['trajectory', 'client'],
})
