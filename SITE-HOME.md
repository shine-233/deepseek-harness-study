...
<div class="dsh-status-strip" aria-label="当前学习仓库门禁状态" data-study-pages="108" data-index-files="2973" data-learning-tests="298" data-example-tests="8" data-structural-errors="0">
...
> 想先动手拆实验？打开<a href="./study-labs.html" target="_blank" rel="noreferrer">实验室总览</a>：十一个离线实验按目的分组，做完顺手回配套课对答案。
...
| 我想知道教材为什么这样设计 | [源码学习项目的渐进式设计](study/32-源码学习项目的渐进式设计.md) | 首页分流、最小示例、练习、自检和 CI 如何组成完整的一轮学习 |
